...
macro_rules! CTL_CODE {
    ($DeviceType:expr, $Function:expr, $Method:expr, $Access:expr) => {
        ((($DeviceType as u32) << 16) | (($Access as u32) << 14) | (($Function as u32) << 2) | ($Method as u32))
    };
}
...
const IOCTL_DEVICE_IO_CONTROL_TEST:u32 = CTL_CODE!(FILE_DEVICE_UNKNOWN, 0x2000, METHOD_BUFFERED, 0);
