...
pub fn get_current_processor_idx() -> u32 {
    return unsafe { KeGetCurrentProcessorNumberEx(core::ptr::null_mut()) } as u32;
}

pub fn protect_non_paged_memory(
    ptr: *mut c_void,
    size: u64,
    protection: u32,
) -> Result<(), &'static str> {
...
pub fn virtual_address_to_physical_address(virtual_address: *mut c_void) -> u64 {
    return unsafe { MmGetPhysicalAddress(virtual_address as _).QuadPart as u64 };
}
