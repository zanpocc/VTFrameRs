...
use wdk::println;
use wdk_sys::{
    ntddk::{KeSetEvent, KeWaitForSingleObject, PsCreateSystemThread, PsTerminateSystemThread},
    ...
    pub fn start(&mut self) -> bool {
        unsafe {
            ...
            let _ = KeWaitForSingleObject(
                self.wait_start_event.as_mut_raw() as _,
                Executive as _,
                KernelMode as _,
                0,
                core::ptr::null_mut(),
...
impl<T> Drop for SystemThread<T> {
    fn drop(&mut self) {
        ...
        unsafe {
            ...
            let _ = KeWaitForSingleObject(
                self.thread_exit_event.as_mut_raw() as _,
                Executive as _,
                KernelMode as _,
                0,
                core::ptr::null_mut(),
